                    ...
                    <form method="POST" action="{{ route('admin.notes.update', $note) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('enfant_id') is-invalid @enderror" id="enfant_id" name="enfant_id" required>
                                    ...
                                    @foreach ($enfants as $enfant)
                                        <option value="{{ $enfant->id }}" {{ old('enfant_id', $note->enfant_id) == $enfant->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" max="20" class="form-control @error('note') is-invalid @enderror" id="note" name="note" value="{{ old('note', $note->note) }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control @error('type_evaluation') is-invalid @enderror" id="type_evaluation" name="type_evaluation" required>
                                    ...
                                    @foreach (['Interrogation', 'Devoir', 'Examen', 'Projet', 'Autre'] as $type)
                                        <option value="{{ $type }}" {{ old('type_evaluation', $note->type_evaluation) == $type ? 'selected' : '' }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('date_evaluation') is-invalid @enderror" id="date_evaluation" name="date_evaluation" value="{{ old('date_evaluation', \Carbon\Carbon::parse($note->date_evaluation)->format('Y-m-d')) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('commentaire') is-invalid @enderror" id="commentaire" name="commentaire" rows="3">{{ old('commentaire', $note->commentaire) }}</textarea>
