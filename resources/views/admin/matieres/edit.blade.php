        ...
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-header bg-warning text-dark">
                    <h4 class="mb-0">Modifier la Matière : {{ $matiere->nom }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.matieres.update', $matiere) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.5" class="form-control @error('coefficient') is-invalid @enderror" id="coefficient" name="coefficient" value="{{ old('coefficient', $matiere->coefficient) }}" required min="0.5" max="10">
                            @error('coefficient')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            <small class="form-text text-muted">Ex: 1, 1.5, 2, 3, etc.</small>
                        </div>
