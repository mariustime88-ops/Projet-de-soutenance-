        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header bg-success text-white">
                    <h4 class="mb-0">Ajouter un Nouvel Élève</h4>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 border-end">
                                ...
                                <div class="row">
                                    <div class="col-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('age') is-invalid @enderror" id="age" name="age" value="{{ old('age') }}" min="1" max="18" required>
                                ...
                                <div class="mb-3">
                                    <label for="photo" class="form-label">Photo d'identité (Max 2Mo)</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('allergies') is-invalid @enderror" id="allergies" name="allergies" rows="2">{{ old('allergies') }}</textarea>
                                    @error('allergies')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label for="info_medicales" class="form-label">Informations Médicales Spécifiques (Traitements, conditions)</label>
                                    <textarea class="form-control @error('info_medicales') is-invalid @enderror" id="info_medicales" name="info_medicales" rows="3">{{ old('info_medicales') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('contact_urgence_nom') is-invalid @enderror" id="contact_urgence_nom" name="contact_urgence_nom" value="{{ old('contact_urgence_nom') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('contact_urgence_numero') is-invalid @enderror" id="contact_urgence_numero" name="contact_urgence_numero" value="{{ old('contact_urgence_numero') }}">
